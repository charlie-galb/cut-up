describe("drag and drop", () => {
    it("user can reorder chunks in the pasteboard using drag and drop", () => {
        ...
        cy.dragAndDrop(".text-snippet", '[data-testid="unused-snippets"]', -100, -200)
        .wait(500)
        cy.get('[data-testid="unused-snippets"] .text-snippet').first().should("have.text", "two and")
        cy.get('[data-testid="unused-snippets"] .text-snippet').first().next().should("have.text", "one and")
    })
    it("user can move chunks from the pasteboard into their current work-in-progress using drag and drop", () => {
        ...
        cy.get('[data-testid="cut-btn"]').click()
        cy.dragAndDrop(".text-snippet", '.wip-container', -60, -155)
    ...
    it("user can move chunks back and forth between the pasteboard their current work-in-progress", () => {
        ...
        cy.get('[data-testid="cut-btn"]').click()
        cy.dragAndDrop(".text-snippet", '[data-testid="line-1"]', 0, -155)
        .wait(1000)
        cy.dragAndDrop('[data-testid="unused-snippets"] .text-snippet', '[data-testid="line-1"]', -20, -10)
        .wait(1000)
        cy.dragAndDrop('[data-testid="line-1"] .text-snippet', '[data-testid="unused-snippets"]', 0, -40)
        .wait(500)
        cy.get('[data-testid="unused-snippets"] .text-snippet').first().should("have.text", "two and")
    })
})